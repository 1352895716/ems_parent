...
public class RecruitController {
	...
	public PageResult  findPage(int page,int rows){			
		return recruitService.findPage(page, rows);
	}
	...
	public PageResult search(@RequestBody Recruit recruit, int page, int rows  ){
		return recruitService.findPage(recruit, page, rows);		
	}
